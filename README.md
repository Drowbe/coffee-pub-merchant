...
![A shop open full screen: the merchant's catalogue as a wall of illustrated tiles with prices, and the buyer's slate down the right with delivery service, destination and running total](documentation/assets/merchant-catalogue-fullscreen.webp)

![The same shop as a list: shelves grouped by category, quantities and prices per row, and the slate showing what is being bought and sold at once](documentation/assets/merchant-shop-list.webp)
