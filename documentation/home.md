...
![A shop open full screen: the merchant's catalogue as a wall of illustrated tiles with prices, and the buyer's slate down the right with delivery service, destination and running total](assets/merchant-catalogue-fullscreen.webp)
